...
function aliasGen(name, lastname){
    ...
    var hackerName = name[0].toUpperCase();
    var hackerLastname = lastname[0].toUpperCase();
    if (isNaN(hackerName) & isNaN(hackerLastname) === true){
      return firstName[hackerName] + " " + surname[hackerLastname];
    } else {
